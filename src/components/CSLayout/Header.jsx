                    ...
                    <>
                        <div className="flex items-center justify-between container h-full w-full">
                            ...
                            <div className="flex items-center justify-between gap-2 lg:gap-4">
                                <div className="hidden sm:flex flex-col items-center bg-white rounded-lg px-3 lg:px-5 py-2">
                                    <img src={"/assets/images/header/mdi_heart-outline.png"} alt="気になる" className="w-5 lg:w-6"/>
                                    <p className="text-xs lg:text-sm font-bold text-[#FF2A3B] whitespace-nowrap">気になる</p>
                                </div>
                                <div className="hidden sm:flex flex-col items-center bg-white rounded-lg p-2">
                                    <img src={"/assets/images/header/mingcute_time-line.png"} alt="最近見た求人" className="w-5 lg:w-6"/>
                                    <p className="text-xs lg:text-sm font-bold text-[#FF2A3B] whitespace-nowrap">最近見た求人</p>
                                </div>
                                <Link 
                                    to={"/members/mypage"} 
                    ...
                    <div className="flex items-center justify-between container w-full">
                        ...
                        <div className="flex items-center gap-2 lg:gap-8 justify-between">
                            <div className="hidden sm:flex items-center justify-between gap-2">
                                <div className="flex flex-col items-center bg-white rounded-lg px-3 lg:px-5 py-2">
                                    <img src={"/assets/images/header/mdi_heart-outline.png"} alt="気になる" className="w-5 lg:w-6"/>
                                    <p className="text-xs lg:text-sm font-bold text-[#FF2A3B] whitespace-nowrap">気になる</p>
                                </div>
                            ...
                            <div className="flex items-center justify-between gap-2">
                                ...
                                >
                                    ...
                                    <p className="text-xs lg:text-sm font-bold text-[#FF2A3B] whitespace-nowrap">ログイン</p>
                                </Link>
                                <Link 
                                    to={"/members/sign_up"} 
                                ...
                                >
                                    <img src={"/assets/images/header/Group 2.png"} alt="register" className="w-5 lg:w-6"/>
                                    <p className="text-xs lg:text-sm font-bold text-white whitespace-nowrap">会員登録</p>
                                </Link>
                            </div>
                        </div>
                    </div>
