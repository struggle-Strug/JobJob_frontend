    ...
    <>
      ...
      <section className="flex justify-between items-center max-w-[1440px] mx-auto h-12">
        ...
        <div className='flex items-center gap-8'>
          ...
          <p className='text-[#F53544] font-semibold bg-[#F1F1F1] rounded-3xl px-4 py-2'>ログイン</p>
          <p className='text-[#F53544] font-semibold bg-[#F1F1F1] rounded-3xl px-4 py-2'>新規登録</p>
        </div>
      </section>
