                ...
                <div className="flex flex-col items-center justify-between mt-12 border-[1.5px] border-[#a7a3a3] rounded-lg p-4 bg-white px-8">
                        ...
                        <div className="flex flex-col px-2">
                            ...
                            <div className="duration-300 overflow-hidden mt-4">
                                <div className="flex justify-start gap-4">
                                    <Input type="email" placeholder="example@jobjob.com" className="w-3/4 py-2 bg-[#F5F5F5]" onChange={onChangeEmail}/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col w-4/5 mt-4">
                        <div className="flex flex-col px-2">
                            ...
                            <div className="duration-300 overflow-hidden mt-4">
                                <div className="flex justify-start gap-4">
                                    <Input type="password" placeholder="" className="w-3/4 py-2 bg-[#F5F5F5]" onChange={onChangePassword}/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-start mt-4 gap-4 w-4/5 pl-2">
                        <button className="bg-[#FF2A3B] hover:bg-[#bc212e] duration-300 text-white py-3 px-4 rounded-lg mt-5" onClick={onSubmit}>ログイン</button>
                    </div>
                </div>
            </div>
        </div>
