    ...
    return (
        <>
            ...
            <section className='max-w-[1440px] mx-auto flex flex-col justify-center py-20 gap-20 px-4'>
                ...
                <img src="/assets/images/companytop/Rectangle_13.png" alt="jobjob" className='mt-4'/>
                </div>
                <div className='flex flex-col items-center gap-12 max-w-[1000px] mx-auto'>
                <div className='flex items-center gap-4 w-full'>
                    <div className='flex flex-col items-center'>
                    <img src="/assets/images/companytop/Group 11.png" alt="group" className='w-full'/>
                    <p className='lg:text-xl md:text-lg text-base font-bold mt-4'>求人掲載から採用まで完全無料!</p>
                    </div>
                    <div className='flex flex-col items-center'>
                    <img src="/assets/images/companytop/Group 12.png" alt="group" className='w-full'/>
                    <p className='lg:text-xl md:text-lg text-base font-bold mt-4'>掲載期間は無制限!</p>
                    </div>
                    <div className='flex flex-col items-center'>
                    <img src="/assets/images/companytop/Group 13.png" alt="group" className='w-full'/>
                    <p className='lg:text-xl md:text-lg text-base font-bold mt-4'>求人掲載から採用まで完全無料!</p>
                    </div>
                </div>
            ...
            <div className='flex flex-col items-center max-w-[1440px] mx-auto'>
                ...
                <div className='grid grid-cols-3 max-w-[670px] w-full xl:gap-8'>
                    ...
                    <img src="/assets/images/companytop/image 12.png" alt="" className='lg:w-full md:w-3/4 mx-auto'/>
                    </div>
                    <div className='grid grid-cols-1'>
                    <img src="/assets/images/companytop/image 13.png" alt="" className='lg:w-full md:w-3/4 mx-auto'/>
                    </div> 
                    <div className='grid grid-cols-1'>
                    <img src="/assets/images/companytop/image 14.png" alt="" className='lg:w-full md:w-3/4 mx-auto'/>
                    </div>
                </div>
                <div className="max-w-[600px] mx-auto border-2 border-red-500 rounded-lg p-6 md:p-8">
                    ...
                    <img src="/assets/images/companytop/Vector.png" alt="vector" className='border-none'/>
                    </span>
            ...
            <section className='relative mt-12 text-center xl:h-80 sm:h-48 overflow-hidden'>
                ...
                <img className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-auto" src="/assets/images/companytop/image 22.png" alt="description" />
            ...
            <section className='mt-[-1rem] flex flex-col justify-center py-20 gap-20 bg-[#F8F8F8] px-4'>
                ...
                <div className='flex items-center gap-4 w-full'>
                    ...
                    <img src="/assets/images/companytop/image 16.png" alt="group" className='w-full'/>
                    ...
                    <img src="/assets/images/companytop/Polygon 1.png" alt="triangle" className='mx-[-2rem] mt-[-6rem]'/>
                    <div className='flex flex-col items-center bg-white shadow-xl rounded-lg p-4 flex-1 h-[420px]'>
                    <img src="/assets/images/companytop/image 15_1.png" alt="group" className='w-full'/>
                    <p className='lg:text-lg md:text-base text-sm font-bold mt-4 text-[#FF6B56] text-center'>
                        JobJobに掲載
                        <br />
                        (最短当日)
                    ...
                    <img src="/assets/images/companytop/Polygon 1.png" alt="triangle" className='mx-[-2rem] mt-[-6rem]'/>
                    <div className='flex flex-col items-center bg-white shadow-xl rounded-lg p-4 flex-1 h-[420px]'>
                    <img src="/assets/images/companytop/image 15.png" alt="group" className='w-full'/>
            ...
            <section className="px-4">
                ...
                <img src="/assets/images/companytop/image 7.png" alt="" className='w-3/5 mt-4'/>
                <div className='flex flex-col justify-center gap-4 max-w-[1000px] mx-auto mt-4'>
                    ...
                    <div className='flex items-center gap-2'>
                        ...
                        <img src="/assets/images/companytop/Group 6.png" alt="" className=''/>
                    </div>
                    <div className='flex items-center gap-2'>
                        <div className='flex flex-col justify-start'>
                        ...
                        <img src="/assets/images/companytop/Group 10.png" alt="" className=''/>
                    </div>
                    </div>
                    ...
                    <div className='flex items-center gap-2'>
                        ...
                        <img src="/assets/images/companytop/Group 8.png" alt="" className='pl-4'/>
                    </div>
                    <div className='flex items-center gap-2'>
                        ...
                        <img src="/assets/images/companytop/Group 9.png" alt="" className=''/>
                    </div>
                    </div>
                </div>
                </div>
            ...
            <section className='flex flex-col justify-center mt-20 px-4'>
                ...
                <div className='flex flex-col gap-4 w-full mt-12'>
                    ...
                    <img src="/assets/images/companytop/Group 4.png" alt="group" className=''/>
                    <p className='text-md font-bold justify-start'>本当に無料で使えますか？</p>
                    </div>
                    <div className='flex items-center justify-start gap-4'>
                    <img src="/assets/images/companytop/Group 5.png" alt="group" className='-translate-y-[50%]'/>
