        ...
        <div className="pt-16 pb-8 bg-[#EFEFEF] h-full">
            <div className="max-w-[1000px] mx-auto bg-white shadow-lg">
                    ...
                    <div className="border-b-[1px] border-[#EFEFEF]">
                        <div className="flex w-full border-t-[1px] border-[#EFEFEF] mt-4">
                            ...
                            <div className="w-3/4 p-4">
                                <Input placeholder="株式会社ジョブジョブ" className="w-full h-10" />
                            </div>
                        </div>
                        <div className="flex w-full border-t-[1px] border-[#EFEFEF]">
                            ...
                            <div className="w-3/4 p-4">
                                <Input placeholder="カブシキカイシャジョブジョブ" className="w-full h-10" />
                            </div>
                        </div>
                        <div className="flex w-full border-t-[1px] border-[#EFEFEF]">
                            ...
                            <div className="w-3/4 p-4">
                                ...
                                <div className="w-full flex items-center gap-6 mt-4">
                                    <Input placeholder="山田" className="w-1/2 h-10" />
                                    <Input placeholder="太郎" className="w-1/2 h-10" />
                                </div>
                            </div>
                        </div>
                        <div className="flex w-full border-t-[1px] border-[#EFEFEF]">
                            ...
                            <div className="w-3/4 p-4 flex items-center gap-6">
                                <Input placeholder="ヤマダ" className="w-1/2 h-10" />
                                <Input placeholder="タロウ" className="w-1/2 h-10" />
                            </div>
                        </div>
                        <div className="flex w-full border-t-[1px] border-[#EFEFEF]">
                            <div className="w-1/4 p-4 bg-[#f5f5f5] flex items-center">
                            ...
                            <div className="w-3/4 p-4 flex flex-col items-start">
                                ...
                                <Input placeholder="03-1234-5678" className="w-full h-10 mt-4" />
                        ...
                        <div className="flex w-full border-t-[1px] border-[#EFEFEF]">
                            ...
                            <div className="w-3/4 p-4">
                                <Input placeholder="jobjob@example.com" className="w-full h-10" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-center gap-4 px-8 pb-4">
                    <Link to={"#"} className="lg:text-base md:text-sm text-xs text-blue-500 flex items-center gap-1 hover:underline">利用規約はこちら<GoLink className="text-blue-500"/></Link>
