      ...
      <div className="max-w-[1000px] mx-auto bg-white shadow-lg">
        ...
        <div className="p-6">
          ...
          <p className="lg:text-sm text-xs text-[#343434] pt-1">
            ...
            「勤続支援金」とは、求職者が本サービスを通じてお客様に採用され、当社が別途定める一定期間の勤続を達成した場合、当社から求職者へ支払う金銭をいいます。
          </p>
          <h1 className="lg:text-lg md:text-base text-sm font-bold text-[#343434] pt-4">
            第3条（契約の成立）
          </h1>
          ...
          <p className="lg:text-sm text-xs text-[#343434] pt-4">
            <span className="number">1.</span>
            お客様は、本サービスの利用にあたり、本サービスの管理画面その他の方法により当社が別途お客様に提供する「ジョブジョブ採用単価下限早見表」に記載された金額を下限とする採用単価を設定するものとし、お客様が特段の設定行為を取られない場合には、当該下限額を採用単価として設定したものとみなします。なお個別にキャンペーン料金等が設定されている場合は、それを優先します。当社は、「ジョブジョブ採用単価下限早見表」を随時改定することができるものとし、その際は本規約の改定を行う場合の手続に準じるものとします。
          </p>
          <p className="lg:text-sm text-xs text-[#343434] pt-1">
            <span className="number">2.</span>
            本サイトの応募機能から応募した求職者またはスカウトメール等の本サービスのその他の機能を通じて採用した求職者が、第2条第7号に定める採用に該当した場合、お客様は当社に対し、本サービスの利用料金を支払う義務を負うものとし、その義務を負った日を「利用料金発生日」といいます。
          </p>
          <p className="lg:text-sm text-xs text-[#343434] pt-1">
            <span className="number">3.</span>
            前項の「利用料金」は、個別にキャンペーン料金等が設定されている場合でない限り、求職者が応募した時点においてお客様が本サービスにおいて設定していた採用単価（消費税別）に採用人数を乗じた金額とします。また、本サービスにおける求職者の応募が確認できない場合でも、スカウトメール等の本サービスのその他の機能を通じて採用した場合、お客様が当該サービスを利用した時点において設定していた採用単価（消費税別）に採用人数を乗じた金額を「利用料金」とします。なお、求職者が応募したまたはスカウト等を受けた採用職種と、お客様が採用した時点の採用職種とが異なる場合、またはお客様の募集職種に対し資格に応じて複数の採用単価（消費税別）が設定されており、採用した求職者が当該複数の資格を有している場合、もっとも高い金額の採用単価を「利用料金」とみなすこととします。
          </p>
          <p className="lg:text-sm text-xs text-[#343434] pt-1">
            <span className="number">4.</span>
          ...
          <p className="lg:text-sm text-xs text-[#343434] pt-1">
            <span className="number">8.</span>
            お客様は、本サービスにおける有償オプションサービス（オプションサービスとは、本サービスのうち、求人広告掲載サービス以外のサービスをいいます。以下同じです。）を利用した際には、第3項に定める利用料金とは別に各オプションサービスについての料金（以下、利用料金、追加の利用料金とあわせて「利用料金等」といいます。）を支払う義務を負うものとします。
          </p>
          <h1 className="lg:text-lg md:text-base text-sm font-bold text-[#343434] pt-4">
            第5条（利用料金等の支払い・返金）
          </h1>
          ...
          <p className="lg:text-sm text-xs text-[#343434] pt-1">
            <span className="number">4.</span>
            前条5項および6項に基づきお支払いいただく追加料金については、前項に従った早期退職返金は適用しないものとします。
          </p>
          <p className="lg:text-sm text-xs text-[#343434] pt-1">
            <span className="number">5.</span>
            お客様は、本サービスの利用に際し、ユーザーに本規約のすべてを遵守させるものとします。ユーザーによる本規約の違反は、お客様による本規約の違反とみなし、お客様は、当該ユーザーと連帯して責任を負います。
          ...
          <p className="lg:text-sm text-xs text-[#343434] pt-1">
            <span className="number">6.</span>{" "}
            お客様が本サービスを利用する前から知得していた求職者を採用する場合は、求職者による本サービスへの応募時より前にお客様が当該求職者の採用を検討していた具体的事実を客観的に明らかにする資料を当社に提供し、当社がそれを承諾した場合のみ、利用料金の免除を受けることができます。当社へ報告せずに採用していた場合は、第7条3項(1)に該当するものとします。
          </p>
          <h1 className="lg:text-lg md:text-base text-sm font-bold text-[#343434] pt-4">
            第7条（損害賠償・違約金）
          </h1>
          ...
          <p className="lg:text-sm text-xs text-[#343434] pt-1">
            ...
            <br />
            <span className="number pt-1">(3)</span>{" "}
            第4条5項および6項の規定により、お客様が追加の利用料金の支払義務を負うにもかかわらず、虚偽の事実を回答した場合：150万円。但し、その雇用についての追加の利用料金が150万円を超える場合には、当該追加の利用料金と同額。
            <br />
            <span className="number pt-1">(4)</span>{" "}
            求職者を採用した際に、第5条3項に定める早期退職返金について虚偽の申請を行った場合：150万円。但し、その雇用についての利用料金が150万円を超える場合には、当該利用料金と同額。
          </p>
          <p className="lg:text-sm text-xs text-[#343434] pt-1">
            <span className="number">4.</span>
            お客様が誤って求職者の採用を報告し、その結果、当社がその求職者に対して勤続支援金を支払った場合は、お客様はその勤続支援金の額を当社に損害賠償として支払うものとします。
          </p>
          <p className="lg:text-sm text-xs text-[#343434] pt-1">
            <span className="number">5.</span>
          ...
          <p className="lg:text-sm text-xs text-[#343434] pt-4">
            <span className="number">1.</span>
            本サービスにおける個人情報の取り扱いに関しては、当社が別途定めている「個人情報保護方針」および「ジョブジョブにおける個人情報の取扱いについて」に従うものとします。お客様は本サービスを利用する場合には「ジョブジョブにおける個人情報の取扱いについて」に従うことを承諾したものとみなします。
          </p>
          <p className="lg:text-sm text-xs text-[#343434] pt-1">
            <span className="number">2.</span>
