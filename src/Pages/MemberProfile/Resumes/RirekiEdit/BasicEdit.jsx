            ...
            <div className="flex flex-col w-full h-full">
                ...
                <div className="flex flex-col items-start justify-center w-full bg-white rounded-lg p-4 shadow-xl mt-2">
                    ...
                    <div className="flex items-center justify-center w-full mt-4">
                        ...
                        <div className="flex items-center justify-start gap-2 w-3/5">
                            <Select options={prefecturesOptions} className="w-1/3" value={prefecture} onChange={(value) => setPrefecture(value)}/>
                        </div>
                    </div>
                    <div className="flex items-center justify-center w-full mt-4">
                        <div className="flex items-center justify-start gap-2 w-2/5">
                    ...
                    {otherContacts &&
                        <>
                            ...
                            <div className="flex items-center justify-center w-full mt-4">
                                ...
                                <div className="flex items-center justify-start gap-2 w-3/5">
                                    <Select options={prefecturesOptions} className="w-1/3" value={otherContactsDetail.prefecture} onChange={(value) => setOtherContactsDetail({...otherContactsDetail, prefecture: value})}/>
                                </div>
                            </div>
                        </>
                    }
