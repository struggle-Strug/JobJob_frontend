        ...
        <>
            <div className="flex flex-col w-full h-full">
                <div className="flex items-center justify-start w-full bg-white rounded-lg p-4 shadow-xl">
                    <p className="lg:text-2xl md:text-xl text-lg font-bold text-[#343434]">マイページ</p>
                </div>
                <div className="flex items-center justify-center gap-4 w-full bg-white rounded-lg py-4 px-8 mt-4 shadow-xl">
                    <div className="flex flex-col w-1/2">
                        <p className="lg:text-lg md:text-base text-sm font-bold text-[#FF2A3B]">ご希望の求人を探してみましょう！</p>
                        <p className="lg:text-[1rem] md:text-[0.8rem] text-[#343434] mt-2">思いつくキーワードで求人を検索してみましょう</p>
                    </div>
