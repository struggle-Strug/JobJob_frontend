...
const LinkRequirement = () => {
  ...
  return (
    <div className="relative min-h-screen bg-white rounded-lg pt-16 clcontainer">
      <h1 className="lg:text-xl text-lg font-bold text-[#343434]">{`リンク掲載のお願い<H1>`}</h1>
      <h2 className="lg:text-lg text-base font-bold text-[#343434] mt-8">{`求人を見てもらいやすい<H2>`}</h2>
      ...
      <h2 className="lg:text-lg text-base font-bold text-[#343434] mt-8">{`採用ホームページとして活用<H2>`}</h2>
      <p className="text-sm text-[#343434] mt-2">
        ジョブジョブに掲載いただいている施設ページ・求人ページを貴社の採用ホームページとして利用することで新たに採用ページを作成する手間が省けます。
      </p>
      <h2 className="lg:text-lg text-base font-bold text-[#343434] mt-8">{`リンク掲載は下記HTMLソースをコピーして簡単設置<H2>`}</h2>
      <p className="text-sm text-[#343434] mt-2">
        ご希望の見た目のバナーやテキストのHTMLソースをコピーし貴社サイトの適切な場所にそのまま貼り付けるだけで掲載いただけます。
      </p>
      <h3 className="lg:text-base text-sm font-bold text-[#343434] mt-8">{`バナー（728×90）<h3>`}</h3>
      <img
      ...
      <h3 className="lg:text-base text-sm font-bold text-[#343434] mt-8">{`バナー（320×50）<h3>`}</h3>
      <img
      ...
      <div className="bg-slate-200 p-4 rounded-lg mt-2">
        <p className="text-sm text-[#343434]">
          {`<a target="_blank" href="https://jobjob-jp.com/"><img alt="日本最大級の医療・介護・保育の求人サイト ジョブジョブ" src="バナーのリンクが入ります" /></a>`}
        </p>
      </div>
      <button
        onClick={() =>
      ...
      <h3 className="lg:text-base text-sm font-bold text-[#343434] mt-8">{`テキストリンク<h3>`}</h3>
      <p className="text-sm text-[#343434] mt-2">
