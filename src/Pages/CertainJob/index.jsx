    ...
    const renderPrefectureSection = (region, prefectures) => (
        <div className="col-span-1 flex flex-col justify-start items-center">
            <div className="w-full px-2 lg:px-4">
                <p className="text-xs lg:text-base font-bold text-[#343434] border-b-[1px] border-[#bdbdbd] w-full text-center py-2 lg:py-3">{region}</p>
            </div>
                ...
                <div className="bg-[#EFEFEF]">
                    <section className='max-w-[1100px] mx-auto bg-white rounded-lg px-8 lg:px-12 py-6 lg:py-12'>
                        <p className="flex flex-wrap gap-1 items-end">
                            {feature !== "" && (
                                <>
                                    <span className="text-base lg:text-xl font-bold text-[#343434]">{getFeatureKeyByValue(feature)}</span>
                                    <span className="text-xs lg:text-base text-[#343434]">の</span>
                                </>
                            )}
                            {employmentType !== "" && (
                                <>
                                    <span className="text-base lg:text-xl font-bold text-[#343434]">{getEmploymentTypeKeyByValue(employmentType)}</span>
                                    <span className="text-xs lg:text-base text-[#343434]">の</span>
                                </>
                            )}
                            <span className="text-base lg:text-xl font-bold text-[#343434]">{JobType}</span>
                            <span className="text-xs lg:text-base text-[#343434]">の</span>
                        </p>
                        <p className="text-sm lg:text-lg text-[#343434]">求人・転職・就職・アルバイト募集情報</p>
                    </section>
                    ...
                    <section className='max-w-[1100px] mx-auto bg-white rounded-lg mt-4'>
                        <div className="grid grid-cols-3 w-full px-2">
                            <button 
                                onClick={() => setType("1")} 
                                className={`col-span-1 flex items-center justify-center hover:border-b-4 border-[#FF2A3B] py-2 lg:py-4 duration-100 ${isSelected("1") ? "border-b-4 border-[#FF2A3B]" : ""}`}
                            >
                                <img src="/assets/images/dashboard/gg_pin.png" alt="map" className="w-4 lg:w-5 pt-0.5" />
                                <p className="text-xs lg:text-md font-bold text-[#343434] duration-300 ml-1">市区町村から選択</p>
                            </button>
                            <button 
                                onClick={() => setType("2")} 
                                className={`col-span-1 flex items-center justify-center hover:border-b-4 border-[#FF2A3B] py-2 lg:py-4 duration-100 ${isSelected("2") ? "border-b-4 border-[#FF2A3B]" : ""}`}
                            >
                                <img src="/assets/images/dashboard/material-symbols_check-box-outline.png" alt="map" className="w-4 lg:w-5 pt-0.5" />
                                <p className="text-xs lg:text-md font-bold text-[#343434] duration-300 ml-1">雇用形態・給与から選択</p>
                            </button>
                            <button 
                                onClick={() => setType("3")} 
                                className={`col-span-1 flex items-center justify-center hover:border-b-4 border-[#FF2A3B] py-2 lg:py-4 duration-100 ${isSelected("3") ? "border-b-4 border-[#FF2A3B]" : ""}`}
                            >
                                <img src="/assets/images/dashboard/mdi_tag-outline.png" alt="map" className="w-4 lg:w-5 pt-0.5" />
                                <p className="text-xs lg:text-md font-bold text-[#343434] duration-300 ml-1">特徴から選択</p>
                            </button>
                        </div>
                        ...
                        {type === "2" && (
                            <div className="w-full p-4 lg:p-6">
                                <div className="mb-6">
                                    <p className="text-sm lg:text-base text-[#343434] font-bold mb-4">雇用形態</p>
                                    <div className="flex flex-wrap items-center gap-4">
                                        {Object.keys(EmploymentType).map((employmentTypeKey, index) => (
                                            <Checkbox 
                                                key={index} 
                                                onChange={() => setEmploymentType(EmploymentType[employmentTypeKey])} 
                                                checked={employmentType === EmploymentType[employmentTypeKey]}
                                            >
                                                <span className="text-xs lg:text-sm">{employmentTypeKey}</span>
                                            </Checkbox>
                                        ))}
                                    </div>
                                </div>
                                ...
                                <div className="mb-6">
                                    <p className="text-sm lg:text-base text-[#343434] font-bold mb-4">給与</p>
                                    <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
                                        <div className="flex items-center gap-2">
                                            <span className="text-xs lg:text-sm font-bold text-[#343434]">月給</span>
                                            <Select
                                            ...
                                            />
                                            <span className="text-xs lg:text-sm text-[#343434]">万円以上</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <span className="text-xs lg:text-sm font-bold text-[#343434]">時給</span>
                                            <Select
                                                ...
                                                className="w-32 lg:w-40"
                                            />
                                            <span className="text-xs lg:text-sm text-[#343434]">円以上</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div key={index} className="mb-6">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                                            {Object.keys(section.features).map((featureKey, idx) => (
                                                <Checkbox
                                                    key={idx}
                                                    onChange={() => setFeature(section.features[featureKey])}
